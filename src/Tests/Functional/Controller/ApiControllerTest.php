...
namespace Evrinoma\HistoryBundle\Tests\Functional\Controller;

use Evrinoma\HistoryBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.history.test.functional.action.history';
    ...
    {
        return [FixtureInterface::HISTORY_FIXTURES];
    }
}
